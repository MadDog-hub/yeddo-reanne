...
import cover1Image from '@assets/cover1_1762410458786.jpg';
import cover2Image from '@assets/cover2_1762410458787.jpg';
import cover3Image from '@assets/cover3_1762410458787.jpg';
...
const Index = () => {
  ...
  return (
    <AnimationContext.Provider value={{ animationsEnabled }}>
      ...
      >
        <source
          src="https://res.cloudinary.com/dwzg0zgwp/video/upload/v1762410600/ytmp3free.cc_press-hit-play-tulipan-official-lyric-video-youtubemp3free.org_2_g0cova.mp3"
          type="audio/mpeg"
        />
