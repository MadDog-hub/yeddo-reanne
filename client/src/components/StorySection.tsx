...
// Love story images
import lovestory1 from '@assets/lovestory1_1762410441409.jpg';
import lovestory2 from '@assets/lovestory2_1762410441410.jpg';
import lovestory3 from '@assets/lovestory3_1762410441410.jpg';
import lovestory4 from '@assets/lovestory4_1762410441411.jpg';
import lovestory5 from '@assets/lovestory5_1762410441411.jpg';
  ...
  const storyCards = [
    {
      id: 1,
      title: "How We Met",
      text: "At one of the booths in Philippine Arena during THIS IS KADIWA, out of thousands of people in that area, we met. A divine appointment among the crowd that would change our lives forever.",
      image: lovestory1,
      icon: Sparkles
    },
    {
      id: 2, 
      title: "Our Journey",
      text: "From that chance encounter, our friendship blossomed into something more. Through shared faith and countless moments together, we discovered a love worth celebrating.",
      image: lovestory2,
      icon: Heart
    },
    {
      ...
      text: "Our relationship grew stronger with each passing day. We learned, laughed, and built a foundation of love rooted in faith and mutual respect.",
      image: lovestory3,
      icon: Star
    },
    {
      id: 4,
      title: "The Promise",
      text: "What started at Philippine Arena led us to this beautiful moment. Today, we make our commitment official before God and our loved ones.",
      image: lovestory4,
      icon: Infinity
    },
    {
      id: 5,
      title: "Our Future",
      text: "As we begin this new chapter, we're grateful for God's guidance and for all the people who have supported us along the way. Together, we step into forever.",
      image: lovestory5,
      icon: Ship
    }
  ];
      ...
      >
        ...
        >
          ...
          {storyCards.map((card, index) => (
            ...
            >
              <div 
                className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-16 items-center h-full relative overflow-hidden rounded-3xl p-8 transition-all duration-300 bg-white dark:bg-white/5 border border-primary/10 shadow-[0_12px_35px_rgba(230,150,180,0.4)]"
                style={{
                  background: 'white'
                }}
            ...
            <div className="max-w-4xl mx-auto text-center relative">
              ...
              <div className="relative z-10 space-y-6 sm:space-y-8">
                ...
                <div className="max-w-2xl mx-auto">
                  <p className="text-lg sm:text-xl leading-relaxed italic text-foreground">
