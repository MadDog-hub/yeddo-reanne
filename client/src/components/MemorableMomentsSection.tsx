...
// Prenup photos
import prenup1 from '@assets/prenup1_1762409305899.jpg';
import prenup2 from '@assets/prenup2_1762409305899.jpg';
import prenup3 from '@assets/prenup3_1762409305900.jpg';
import prenup4 from '@assets/prenup4_1762409305900.jpg';
import prenup5 from '@assets/prenup5_1762409305901.jpg';
import prenup6 from '@assets/prenup6_1762409305901.jpg';
import prenup7 from '@assets/prenup7_1762409305901.jpg';
import prenup8 from '@assets/prenup8_1762409305902.jpg';
import prenup9 from '@assets/prenup9_1762409305902.jpg';
import prenup10 from '@assets/prenup10_1762409305903.jpg';
import prenup11 from '@assets/prenup11_1762409305903.jpg';
import prenup12 from '@assets/prenup12_1762409305904.jpg';

const MemorableMomentsSection = () => {
  const [selectedImage, setSelectedImage] = useState<number | null>(null);

  const images = [
    { src: prenup1, alt: "Prenup photo 1", height: "h-64" },
    { src: prenup2, alt: "Prenup photo 2", height: "h-80" },
    { src: prenup3, alt: "Prenup photo 3", height: "h-72" },
    { src: prenup4, alt: "Prenup photo 4", height: "h-96" },
    { src: prenup5, alt: "Prenup photo 5", height: "h-64" },
    { src: prenup6, alt: "Prenup photo 6", height: "h-80" },
    { src: prenup7, alt: "Prenup photo 7", height: "h-72" },
    { src: prenup8, alt: "Prenup photo 8", height: "h-64" },
    { src: prenup9, alt: "Prenup photo 9", height: "h-96" },
    { src: prenup10, alt: "Prenup photo 10", height: "h-80" },
    { src: prenup11, alt: "Prenup photo 11", height: "h-72" },
    { src: prenup12, alt: "Prenup photo 12", height: "h-64" }
  ];
