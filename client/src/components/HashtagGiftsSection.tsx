  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-12">
        {/* Oh Snap! Section */}
        <motion.div 
          className="bg-white border border-border rounded-xl p-8 shadow-[0_12px_35px_rgba(230,150,180,0.4)] hover-elegant transition-all duration-500 text-center"
        ...
        >
          ...
          <motion.div
            className="bg-white border border-border/50 rounded-xl p-6 max-w-2xl mx-auto shadow-[0_8px_20px_rgba(230,150,180,0.3)]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
