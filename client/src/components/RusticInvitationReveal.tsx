...
import prenup1 from '@assets/groom (1)_1762409889243.jpg';
import prenup2 from '@assets/couple_1762409948005.jpg';
import prenup3 from '@assets/bride (1)_1762409889244.jpg';
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen py-12 px-4">
      ...
      <div className="relative z-10 mb-16 flex flex-wrap items-center justify-center gap-6 max-w-5xl">
        ...
        >
          ...
          {/* Polaroid Frame */}
          <div 
            className="bg-white p-3 pb-12 transform hover:scale-105 transition-transform duration-300"
            style={{
              boxShadow: '0 8px 20px rgba(230,150,180,0.5), 0 4px 10px rgba(230,150,180,0.3)'
            }}
          >
      ...
      >
        ...
        <div 
          ...
          style={{
            ...
            boxShadow: `
              0 12px 35px rgba(230,150,180,0.4),
              0 6px 15px rgba(230,150,180,0.25),
