...
const TimelineCard: React.FC<TimelineCardProps> = ({ timelineEvent, i }) => {
    ...
    const getEventDescription = (eventName: string): string => {
        const descriptions: Record<string, string> = {
            "Church Ceremony": "Join us at Iglesia Ni Cristo Locale of Cuidad de Victoria as we exchange our vows and unite in faith.",
            "Picture Taking": "Capture precious moments with the newlyweds and celebrate this joyous occasion together.",
            "Cocktail Hour": "Enjoy light refreshments and mingle with family and friends in a relaxed atmosphere.",
            "Program Begins": "The formal program begins with special performances, speeches, and heartfelt moments.",
            "Lunch Reception": "Join us for a delicious lunch feast as we celebrate our union together."
        };
    ...
    return (
        ...
        >
            ...
            {/* Card */}
            <motion.div 
                className="bg-white border border-primary/20 rounded-xl shadow-[0_12px_35px_rgba(230,150,180,0.4)] overflow-hidden transition-all duration-300 hover:shadow-[0_15px_40px_rgba(230,150,180,0.5)] hover:border-primary/40"
