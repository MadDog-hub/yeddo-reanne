  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <div className="bg-white border border-border rounded-xl p-12 shadow-[0_12px_35px_rgba(230,150,180,0.4)] hover-elegant">
            {/* Icon */}
        ...
        >
          {/* GCash Payment */}
          <div>
            <div className="bg-white border border-border rounded-xl p-8 shadow-[0_12px_35px_rgba(230,150,180,0.4)] hover-elegant">
